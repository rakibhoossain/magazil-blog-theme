...
class Widget_Magazil_Posts_List_Horizontal extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'newsmag_widget_posts_list_horizontal', __( 'Magazil - Posts List Horizontal', 'magazil' ), array(
			'classname'                   => 'newsmag_builder',
			'description'                 => __( 'Images followed by their title. Very useful when used in pairs of 8 or more to draw attention to a selection of posts.', 'magazil' ),
