...
<div class="feature-section">
    <div class="row two-col">
        <div class="col">
            <h3><i class="dashicons dashicons-sos"></i><?php esc_html_e( 'Contact Support', 'magazil' ); ?></h3>
            <p>
        ...
        <div class="col">
            <h3><i class="dashicons dashicons-book-alt"></i><?php esc_html_e( 'Documentation', 'magazil' ); ?></h3>
            <p>
                <i><?php esc_html_e( 'This is the place to go to reference different aspects of the theme. Our online documentation is an incredible resource for learning the ins and outs of using magazil.', 'magazil' ) ?></i>
            </p>
            <p>
                <a target="_blank"
    ...
    <div class="row three-col">
        <div class="col">
            <h3><i class="dashicons dashicons-performance"></i><?php esc_html_e( 'How to speed up wordpress', 'magazil' ); ?></h3>
            <p>
        ...
        <div class="col">
            <h3><i class="dashicons dashicons-analytics"></i><?php esc_html_e( 'Cheap WordPress hosting', 'magazil' ); ?></h3>
            <p>
                <i><?php esc_html_e( 'There are so many services offering cheap WordPress hosting out there that picking a winner can often seem like a game of chance. This article will hopefully allow you to make an informed decision, catered to your needs', 'magazil' ) ?></i>
            </p>
            <p>
                <a target="_blank"
